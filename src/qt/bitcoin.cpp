 ...
 * The TurboStake Developers 2013
 */
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. TurboStake can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "TurboStake:", 7) == 0)
        {
    ...
    app.setOrganizationName("TurboStake");
    app.setOrganizationDomain("TurboStake.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("TurboStake-Qt-testnet");
    else
        app.setApplicationName("TurboStake-Qt");
