...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // TurboStake: get transaction coin age
...
public:
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // TurboStake: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // TurboStake: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;
