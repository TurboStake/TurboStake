...
// Copyright (c) 2014 The TurboStake developers
...
// for both TurboStaked and TurboStake(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of TurboStake releases, the client name should be selected from
